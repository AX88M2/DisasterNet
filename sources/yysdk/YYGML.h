...
YYCEXTERN int64 yyfdiv(int64 _lhs, int64 _rhs);
YYCEXTERN int64 yyfdiv(int64 _lhs, const RValue& _rhs);
//#endif
...
YYCEXTERN bool YYGML_event_object(CInstance* pSelf, CInstance* pOther, int objId, int etype, int enumb);
YYCEXTERN bool YYGML_event_user(CInstance* pSelf, CInstance* pOther, int enumb);
...
YYCEXTERN YYRValue& YYGML_CreateConstantArray(YYRValue& _result, CInstance* selfinst, int count, ...);
...
YYCEXTERN double YYGML_sin(double _val);
...
YYCEXTERN void YYGML_variable_struct_set(CInstance* _pSelf, CInstance* _pOther, const YYRValue& _obj, const YYRValue& _key, const YYRValue& _value);
...
YYCEXTERN int YYGML_GetID(CInstance* pSelf);
YYCEXTERN YYRValue& YYGML_string(CInstance* _pSelf, CInstance* _pOther, YYRValue& _result, int _argc, YYRValue** _args);
...
FORCEINLINE int64 yyfdiv(int64 _lhs, int64 _rhs) FORCEINLINE_ATTR;
FORCEINLINE int64 yyfdiv(int64 _lhs, int64 _rhs)
{
	if (_rhs == 0) {
		YYError("Divide by zero");
	} // end if
	return (int64)((int64)_lhs / (int64)_rhs);
} // end yyfmod
FORCEINLINE int64 yyfdiv(int64 _lhs, const RValue& _rhs) FORCEINLINE_ATTR;
FORCEINLINE int64 yyfdiv(int64  _lhs, const RValue& _rhs)
{
...
struct YYRValue : RValue
{
	...
	YYRValue(const RValue& _v) {
		__localCopy_nodest(*(YYRValue*)&_v);
	} // end YYRValue
	...
	YYRValue(int _val, bool _f, bool _b) {
		kind = VALUE_INT32;
		v32 = _val;
		//YYASSUME(kind == VALUE_REAL);
	}
	...
	YYRValue& operator=(YYObjectBase* _p) {
		__localFree();
		kind = VALUE_OBJECT;
		pObj = _p;
		YYObjectBase* pContainer = GetContextStackTop();
	...
	YYRValue& operator+=(const long rhs) {
		switch (kind) {
		case VALUE_BOOL:
			kind = VALUE_REAL;
		case VALUE_REAL:
	...
	friend YYRValue operator+(const YYRValue& lhs, long rhs) {
		YYRValue tmp(lhs);
		tmp += rhs;
		return tmp;
	} // end operator+
	friend YYRValue operator+(long lhs, const YYRValue& rhs) {
		YYRValue tmp(lhs);
		tmp += rhs;
		return tmp;
	} // end operator+
	...
	friend bool operator==(const YYRValue& _v1, long _v2) {
		return (_v1 == YYRValue(_v2));
	}
	friend bool operator==(long _v1, const YYRValue& _v2) {
		return (YYRValue(_v1) == _v2);
	}
	...
	friend bool operator==(const YYRValue& _v1, YYObjectBase* _v2) {
		return (_v1 == YYRValue(_v2));
	}
...
FORCEINLINE int NOTHROW_ATTR YYGML_array_length(const YYRValue& _arg0)
{
	...
	if ((_arg0.kind == VALUE_ARRAY) && (_arg0.pRefArray != NULL)) {
		ret = _arg0.pRefArray->len;
	} // end if
	return ret;
}
#endif

inline bool YYGML_YYObjectBase_NotEquals(YYObjectBase* _p, int _v)
{
	return true;
}
inline bool YYGML_YYObjectBase_NotEquals(int _v, YYObjectBase* _p)
{
	return true;
}
inline bool YYGML_YYObjectBase_Equals(YYObjectBase* _p, int _v)
{
	return false;
}
inline bool YYGML_YYObjectBase_Equals(int _v, YYObjectBase* _p)
{
	return false;
}

YYCEXTERN YYRValue yyfdiv(const RValue& _lhs, int64 _rhs);
YYCEXTERN YYRValue yyfdiv(const RValue& _lhs, const RValue& _rhs);

FORCEINLINE YYRValue yyfdiv(const RValue& _lhs, int64 _rhs) FORCEINLINE_ATTR;
FORCEINLINE YYRValue yyfdiv(const RValue& _lhs, int64  _rhs)
{
	YYRValue ret;
	switch (_lhs.kind) {
	case VALUE_INT64:
		ret.v64 = (int64)(_lhs.v64 / _rhs);
		ret.kind = VALUE_INT64;
		return ret;
	case VALUE_INT32:
		ret.v32 = (int32)((int64)_lhs.v32 / _rhs);
		ret.kind = VALUE_INT32;
		return ret;
	default:
		ret.val = (double)((int64)_lhs.asReal() / _rhs);
		ret.kind = VALUE_REAL;
		return ret;
	}
} // end yyfdiv
FORCEINLINE YYRValue yyfdiv(const RValue& _lhs, const RValue& _rhs) FORCEINLINE_ATTR;
FORCEINLINE YYRValue yyfdiv(const RValue& _lhs, const RValue& _rhs)
{
	YYRValue ret;
	switch (_lhs.kind) {
	case VALUE_INT64:
		ret.v64 = (int64)(_lhs.v64 / _rhs.asInt64());
		ret.kind = VALUE_INT64;
		return ret;
	case VALUE_INT32:
		ret.v32 = (int32)((int64)_lhs.v32 / _rhs.asInt64());
		ret.kind = VALUE_INT32;
		return ret;
	default:
		ret.val = (double)((int64)_lhs.asReal() / _rhs.asInt64());
		ret.kind = VALUE_REAL;
		return ret;
	}
} // end yyfdiv
